...
--
-- Table structure for table `hy_base_resource`
--
...
/*!40000 ALTER TABLE `hy_base_resource` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `hy_base_resource` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `hy_base_role` WRITE;
/*!40000 ALTER TABLE `hy_base_role` DISABLE KEYS */;
/*!40000 ALTER TABLE `hy_base_role` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `hy_base_role_resource` WRITE;
/*!40000 ALTER TABLE `hy_base_role_resource` DISABLE KEYS */;
/*!40000 ALTER TABLE `hy_base_role_resource` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `hy_base_user`
--

LOCK TABLES `hy_base_user` WRITE;
/*!40000 ALTER TABLE `hy_base_user` DISABLE KEYS */;
/*!40000 ALTER TABLE `hy_base_user` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `hy_base_user_role`
--

LOCK TABLES `hy_base_user_role` WRITE;
/*!40000 ALTER TABLE `hy_base_user_role` DISABLE KEYS */;
/*!40000 ALTER TABLE `hy_base_user_role` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-11-18 21:24:57
